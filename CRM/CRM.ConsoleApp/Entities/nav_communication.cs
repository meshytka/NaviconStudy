...
namespace CRM.ConsoleApp.Entities
{
	...
	public partial class nav_communication : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<CRM.ConsoleApp.Entities.nav_communicationState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((CRM.ConsoleApp.Entities.nav_communicationState)(System.Enum.ToObject(typeof(CRM.ConsoleApp.Entities.nav_communicationState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public CRM.ConsoleApp.Entities.Contact nav_contact_nav_communication_contactid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<CRM.ConsoleApp.Entities.Contact>("nav_contact_nav_communication_contactid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("nav_contact_nav_communication_contactid");
				this.SetRelatedEntity<CRM.ConsoleApp.Entities.Contact>("nav_contact_nav_communication_contactid", null, value);
